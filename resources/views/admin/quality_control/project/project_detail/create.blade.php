...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Add Project Detail for {{ $projectHeader->name }}</h4>
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-6">
                <div class="card-body">
                    <form action="{{ route('admin.qc.project.project_detail.store', $projectHeader->id) }}" method="POST">
                        @csrf
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="text" class="form-control" name="equipment_code" value="{{ old('equipment_code') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Production Number <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="production_number" value="{{ old('production_number') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="pipe_type" value="{{ old('pipe_type') }}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Pipe Size <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="pipe_size" value="{{ old('pipe_size') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Pipe Qty <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="pipe_qty" value="{{ old('pipe_qty') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Pipe Length <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="pipe_length" value="{{ old('pipe_length') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="jacketing_type_1" name="jacketing_type" value="1" onclick="showJacketingSizeOptions(1)" required checked />
                                    <label class="form-check-label" for="jacketing_type_1">Galvanized</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="jacketing_type_2" name="jacketing_type" value="2" onclick="showJacketingSizeOptions(2)" required />
                                    <label class="form-check-label" for="jacketing_type_2">Aluminium</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="jacketing_type_3" name="jacketing_type" value="3" onclick="showJacketingSizeOptions(3)" required />
                                    <label class="form-check-label" for="jacketing_type_3">Stainless</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="jacketing_type_4" name="jacketing_type" value="4" onclick="showJacketingSizeOptions(4)" required />
                                    <label class="form-check-label" for="jacketing_type_4">PVC</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="jacketing_type_5" name="jacketing_type" value="5" onclick="showJacketingSizeOptions(5)" required />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="jacket_od" value="{{ old('jacket_od') }}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Density <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="density" value="{{ old('density') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Thickness Pu 1 <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="thickness_pu_1" value="{{ old('thickness_pu_1') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Thickness Pu 2 <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="thickness_pu_2" value="{{ old('thickness_pu_2') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Thickness Pu 3 <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="thickness_pu_3" value="{{ old('thickness_pu_3') }}" required />
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">Thickness Pu 4 <span class="text-danger">*</span></label>
                            <div class="col-sm-2">
                                <input type="number" class="form-control" name="thickness_pu_4" value="{{ old('thickness_pu_4') }}" required />
