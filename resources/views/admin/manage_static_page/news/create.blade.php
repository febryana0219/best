...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('admin.static_page.news.index') }}" class="btn btn-secondary waves-effect">Back to News</a>
    </div>
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-6">
                <div class="card-body">
                    <form action="{{ route('admin.static_page.news.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
