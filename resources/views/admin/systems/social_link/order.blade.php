...
<div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-style1">
            ...
            <li class="breadcrumb-item active">Social Link Order</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Social Link Order</h4>
    ...
    <!-- Sortable List -->
    <form action="{{ route('admin.system.social_link.order.update') }}" method="POST">
        @csrf
        <div class="card mb-4">
            <div class="card-body">
